...
this.simulation = d3.forceSimulation(nodes)
  ...
  .force('collide', d3.forceCollide<Node>().radius((d) => d.radius).strength(0.5)) // Ajusta la fuerza de colisión para evitar superposición
  ...
  .force('y', d3.forceY<Node>().y(height / 2).strength(1)) // Aumenta la fuerza en el eje Y para que los nodos converjan hacia el centro de su categoría
