...
class ReactCircleCard extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    ...
    drawChart() {
        if (!this.svgRef.current)
            return;
        const svg = d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ys(this.svgRef.current);
        // Clear previous chart
        svg.selectAll('*').remove();
        const margin = { top: 20, right: 20, bottom: 30, left: 50 };
        const width = +svg.attr('width') - margin.left - margin.right;
        const height = +svg.attr('height') - margin.top - margin.bottom;
        const bubbleSize = d3__WEBPACK_IMPORTED_MODULE_1__/* .scaleSqrt */ .PUr()
            .domain([0, d3__WEBPACK_IMPORTED_MODULE_1__/* .max */ .Fp7(this.props.y2Data) || 0])
            .range([0, Math.sqrt(width * height / this.props.y2Data.length)]);
        const color = d3__WEBPACK_IMPORTED_MODULE_1__/* .scaleOrdinal */ .PKp(d3__WEBPACK_IMPORTED_MODULE_1__/* .schemeCategory10 */ .Cn1)
            .domain(this.props.categories);
        const g = svg.append('g')
            .attr('transform', `translate(${margin.left},${margin.top})`);
        // Create nodes data for force simulation
        const nodes = this.props.y2Data.map((d, i) => ({
            radius: bubbleSize(d),
            value: d,
        ...
        // Tooltip container
        const tooltip = d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ys('body').append('div')
            .attr('class', 'tooltip')
        ...
        // Usando la simulación de fuerzas para evitar superposiciones y agrupar por categoría
        this.simulation = d3__WEBPACK_IMPORTED_MODULE_1__/* .forceSimulation */ .A4v(nodes)
            .force('charge', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceManyBody */ .q5i().strength((d) => {
            // Incrementa la fuerza entre nodos dentro de la misma categoría
            return d.category === this.props.displayName ? -30 : -10;
        }))
            .force('center', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceCenter */ .wqt(width / 2, height / 2))
            .force('collide', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceCollide */ .Hh().radius((d) => d.radius).strength(0.5)) // Ajusta la fuerza de colisión para evitar superposición
            .force('x', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceX */ .RUJ().x((d) => {
            ...
            return categoryWidth * (categoryIndex + 0.5); // Centra los nodos dentro de sus categorías
        }).strength(1)) // Aumenta la fuerza en el eje X para que los nodos converjan hacia el centro de su categoría
            .force('y', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceY */ .Mrm().y(height / 2).strength(1)) // Aumenta la fuerza en el eje Y para que los nodos converjan hacia el centro de su categoría
            .alpha(0.1) // Reducir la velocidad de movimiento general
            .on('tick', () => {
            g.selectAll('.bubble')
        ...
        const drag = d3__WEBPACK_IMPORTED_MODULE_1__/* .drag */ .ohM()
        ...
        const bubble = g.selectAll('.bubble')
            ...
            d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ys(this).attr('stroke', 'black');
            tooltip
                .style('display', 'block')
            ...
            d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ys(this).attr('stroke', 'none');
        ...
        function dragended(event, d) {
            ...
            this.simulation
                .alpha(0.3)
                .force('charge', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceManyBody */ .q5i().strength(5))
                .force('center', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceCenter */ .wqt(width / 2, height / 2))
                .force('collide', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceCollide */ .Hh().radius(d => d.radius + 1))
                .force('x', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceX */ .RUJ().x(d => {
                ...
                .force('y', d3__WEBPACK_IMPORTED_MODULE_1__/* .forceY */ .Mrm().y(height / 2))
                .restart();
        }
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "circleCard" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("svg", { ref: this.svgRef, width: 400, height: 400 })));
    }
}
...
class Visual {
    constructor(options) {
        ...
        this.reactRoot = react__WEBPACK_IMPORTED_MODULE_0__.createElement(_component__WEBPACK_IMPORTED_MODULE_2__/* .ReactCircleCard */ .G, { xData: [], categories: [], y2Data: [], displayName: "Rojo", width: 300, height: 300 });
    ...
    update(options) {
        ...
        this.reactRoot = react__WEBPACK_IMPORTED_MODULE_0__.createElement(_component__WEBPACK_IMPORTED_MODULE_2__/* .ReactCircleCard */ .G, { xData: xData, categories: categories, displayName: displayName, y2Data: y2Data });
        react_dom__WEBPACK_IMPORTED_MODULE_1__.render(this.reactRoot, this.target);
    }
}
...
/* harmony export */   Z: () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var d3_quadtree__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6632);
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3548);
/* harmony import */ var _jiggle_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9778);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(radius) {
  ...
  if (typeof radius !== "function") radius = (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(radius == null ? 1 : +radius);
  ...
  function force() {
    ...
    for (var k = 0; k < iterations; ++k) {
      tree = (0,d3_quadtree__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(nodes, x, y).visitAfter(prepare);
      for (i = 0; i < n; ++i) {
        node = nodes[i];
      ...
      if (data) {
        if (data.index > node.index) {
          var x = xi - data.x - data.vx,
              ...
              l = x * x + y * y;
          if (l < r * r) {
            if (x === 0) x = (0,_jiggle_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(random), l += x * x;
            if (y === 0) y = (0,_jiggle_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(random), l += y * y;
  ...
  force.radius = function(_) {
    return arguments.length ? (radius = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(+_), initialize(), force) : radius;
  };
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A4: () => (/* reexport safe */ _simulation_js__WEBPACK_IMPORTED_MODULE_3__.Z),
/* harmony export */   Hh: () => (/* reexport safe */ _collide_js__WEBPACK_IMPORTED_MODULE_1__.Z),
/* harmony export */   Mr: () => (/* reexport safe */ _y_js__WEBPACK_IMPORTED_MODULE_5__.Z),
/* harmony export */   RU: () => (/* reexport safe */ _x_js__WEBPACK_IMPORTED_MODULE_4__.Z),
/* harmony export */   q5: () => (/* reexport safe */ _manyBody_js__WEBPACK_IMPORTED_MODULE_2__.Z),
/* harmony export */   wq: () => (/* reexport safe */ _center_js__WEBPACK_IMPORTED_MODULE_0__.Z)
/* harmony export */ });
/* harmony import */ var _center_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8505);
/* harmony import */ var _collide_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9281);
/* harmony import */ var _manyBody_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5475);
/* harmony import */ var _simulation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1845);
/* harmony import */ var _x_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(341);
/* harmony import */ var _y_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2688);
...
/* harmony import */ var d3_quadtree__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6632);
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3548);
/* harmony import */ var _jiggle_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9778);
/* harmony import */ var _simulation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1845);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var nodes,
      ...
      random,
      alpha,
      strength = (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(-30),
      strengths,
      distanceMin2 = 1,
  ...
  function force(_) {
    var i, n = nodes.length, tree = (0,d3_quadtree__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(nodes, _simulation_js__WEBPACK_IMPORTED_MODULE_2__.x, _simulation_js__WEBPACK_IMPORTED_MODULE_2__.y).visitAfter(accumulate);
  ...
  function apply(quad, x1, _, x2) {
    ...
    if (w * w / theta2 < l) {
      if (l < distanceMax2) {
        if (x === 0) x = (0,_jiggle_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(random), l += x * x;
        if (y === 0) y = (0,_jiggle_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(random), l += y * y;
  ...
  force.strength = function(_) {
    return arguments.length ? (strength = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(+_), initialize(), force) : strength;
  };
...
/* harmony export */ });
/* harmony import */ var d3_dispatch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6057);
/* harmony import */ var d3_timer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1739);
/* harmony import */ var _lcg_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3168);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(nodes) {
  var simulation,
      ...
      velocityDecay = 0.6,
      forces = new Map(),
      stepper = (0,d3_timer__WEBPACK_IMPORTED_MODULE_0__/* .timer */ .HT)(step),
      event = (0,d3_dispatch__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)("tick", "end"),
      random = (0,_lcg_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)();
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(x) {
  var strength = (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(0.1),
      nodes,
      strengths,
      xz;

  if (typeof x !== "function") x = (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(x == null ? 0 : +x);
  ...
  force.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(+_), initialize(), force) : x;
  };
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(y) {
  ...
  if (typeof y !== "function") y = (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(y == null ? 0 : +y);
  ...
  force.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : (0,_constant_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(+_), initialize(), force) : y;
  };
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   H: () => (/* binding */ addAll),
/* harmony export */   Z: () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
/* harmony export */   Z: () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _quad_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2936);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(x, y, radius) {
  ...
  if (node) quads.push(new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(node, x0, y0, x3, y3));
  if (radius == null) radius = Infinity;
  else {
  ...
  while (q = quads.pop()) {
    ...
    if (node.length) {
      ...
      quads.push(
        new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(node[3], xm, ym, x2, y2),
        new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(node[2], x1, ym, xm, y2),
        new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(node[1], xm, y1, x2, ym),
        new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(node[0], x1, y1, xm, ym)
      );
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ quadtree)
/* harmony export */ });
/* harmony import */ var _add_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9715);
/* harmony import */ var _cover_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6290);
/* harmony import */ var _data_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1145);
/* harmony import */ var _extent_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7059);
/* harmony import */ var _find_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3297);
/* harmony import */ var _remove_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5854);
/* harmony import */ var _root_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(9033);
/* harmony import */ var _size_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(6590);
/* harmony import */ var _visit_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(1034);
/* harmony import */ var _visitAfter_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(6106);
/* harmony import */ var _x_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(220);
/* harmony import */ var _y_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8792);
...
function quadtree(nodes, x, y) {
  var tree = new Quadtree(x == null ? _x_js__WEBPACK_IMPORTED_MODULE_0__/* .defaultX */ .P : x, y == null ? _y_js__WEBPACK_IMPORTED_MODULE_1__/* .defaultY */ .q : y, NaN, NaN, NaN, NaN);
...
treeProto.add = _add_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z;
treeProto.addAll = _add_js__WEBPACK_IMPORTED_MODULE_2__/* .addAll */ .H;
treeProto.cover = _cover_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z;
treeProto.data = _data_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z;
treeProto.extent = _extent_js__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z;
treeProto.find = _find_js__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z;
treeProto.remove = _remove_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z;
treeProto.removeAll = _remove_js__WEBPACK_IMPORTED_MODULE_7__/* .removeAll */ .x;
treeProto.root = _root_js__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z;
treeProto.size = _size_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z;
treeProto.visit = _visit_js__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z;
treeProto.visitAfter = _visitAfter_js__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z;
treeProto.x = _x_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z;
treeProto.y = _y_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z;
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   x: () => (/* binding */ removeAll)
/* harmony export */ });
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(d) {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(callback) {
  ...
  if (node) quads.push(new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(node, this._x0, this._y0, this._x1, this._y1));
  while (q = quads.pop()) {
    if (!callback(node = q.node, x0 = q.x0, y0 = q.y0, x1 = q.x1, y1 = q.y1) && node.length) {
      var xm = (x0 + x1) / 2, ym = (y0 + y1) / 2;
      if (child = node[3]) quads.push(new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(child, xm, ym, x1, y1));
      if (child = node[2]) quads.push(new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(child, x0, ym, xm, y1));
      if (child = node[1]) quads.push(new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(child, xm, y0, x1, ym));
      if (child = node[0]) quads.push(new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(child, x0, y0, xm, ym));
    }
  }
  return this;
}
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(callback) {
  var quads = [], next = [], q;
  if (this._root) quads.push(new _quad_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z(this._root, this._x0, this._y0, this._x1, this._y1));
  while (q = quads.pop()) {
    var node = q.node;
    if (node.length) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   P: () => (/* binding */ defaultX),
/* harmony export */   Z: () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function defaultX(d) {
  return d[0];
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   q: () => (/* binding */ defaultY)
/* harmony export */ });
function defaultY(d) {
  return d[1];
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   PK: () => (/* reexport safe */ _ordinal_js__WEBPACK_IMPORTED_MODULE_0__.Z),
/* harmony export */   PU: () => (/* reexport safe */ _pow_js__WEBPACK_IMPORTED_MODULE_1__._b)
/* harmony export */ });
/* harmony import */ var _ordinal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8973);
/* harmony import */ var _pow_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4177);
...
/* harmony export */ });
/* unused harmony exports powish, default */
...
function powish(transform) {
  var scale = transform(_continuous_js__WEBPACK_IMPORTED_MODULE_0__/* .identity */ .yR, _continuous_js__WEBPACK_IMPORTED_MODULE_0__/* .identity */ .yR),
      exponent = 1;

  function rescale() {
    return exponent === 1 ? transform(_continuous_js__WEBPACK_IMPORTED_MODULE_0__/* .identity */ .yR, _continuous_js__WEBPACK_IMPORTED_MODULE_0__/* .identity */ .yR)
  ...
  return (0,_linear_js__WEBPACK_IMPORTED_MODULE_1__/* .linearish */ .Q)(scale);
}

function pow() {
  var scale = powish((0,_continuous_js__WEBPACK_IMPORTED_MODULE_0__/* .transformer */ .l4)());

  scale.copy = function() {
    return (0,_continuous_js__WEBPACK_IMPORTED_MODULE_0__/* .copy */ .JG)(scale, pow()).exponent(scale.exponent());
  };

  _init_js__WEBPACK_IMPORTED_MODULE_2__/* .initRange */ .o.apply(scale, arguments);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A4v: () => (/* reexport safe */ d3_force__WEBPACK_IMPORTED_MODULE_3__.A4),
/* harmony export */   Cn1: () => (/* reexport safe */ d3_scale_chromatic__WEBPACK_IMPORTED_MODULE_5__.Cn),
/* harmony export */   Fp7: () => (/* reexport safe */ d3_array__WEBPACK_IMPORTED_MODULE_0__.Fp),
/* harmony export */   Hh: () => (/* reexport safe */ d3_force__WEBPACK_IMPORTED_MODULE_3__.Hh),
/* harmony export */   Mrm: () => (/* reexport safe */ d3_force__WEBPACK_IMPORTED_MODULE_3__.Mr),
/* harmony export */   PKp: () => (/* reexport safe */ d3_scale__WEBPACK_IMPORTED_MODULE_4__.PK),
/* harmony export */   PUr: () => (/* reexport safe */ d3_scale__WEBPACK_IMPORTED_MODULE_4__.PU),
/* harmony export */   RUJ: () => (/* reexport safe */ d3_force__WEBPACK_IMPORTED_MODULE_3__.RU),
/* harmony export */   Ys: () => (/* reexport safe */ d3_selection__WEBPACK_IMPORTED_MODULE_6__.Ys),
/* harmony export */   ohM: () => (/* reexport safe */ d3_drag__WEBPACK_IMPORTED_MODULE_2__.oh),
/* harmony export */   q5i: () => (/* reexport safe */ d3_force__WEBPACK_IMPORTED_MODULE_3__.q5),
/* harmony export */   wqt: () => (/* reexport safe */ d3_force__WEBPACK_IMPORTED_MODULE_3__.wq)
/* harmony export */ });
...
/* harmony import */ var d3_drag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5130);
/* harmony import */ var d3_force__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9678);
/* harmony import */ var d3_scale__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1770);
/* harmony import */ var d3_scale_chromatic__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(537);
/* harmony import */ var d3_selection__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3950);
...
if (typeof powerbi !== "undefined") {
    ...
    powerbi.visuals.plugins["Circle_DEBUG"] = Circle_DEBUG;
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Circle_DEBUG);

})();

Circle_DEBUG = __webpack_exports__;
/******/ })()
;
